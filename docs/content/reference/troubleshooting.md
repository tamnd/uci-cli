...
Most of these come down to network reality or how uci serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

uci rate-limits like any public site. uci already paces
...
Where a surface is gated, uci reads a cookie or token you supply
...
`uci`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what uci actually did
